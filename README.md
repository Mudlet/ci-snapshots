...
Download and unpack or Clone the software into a PHP-Enabled server directory.  Copy and rename the file `config.example.php` to `config.php` and edit the configuration.  
